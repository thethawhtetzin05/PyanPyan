...
## Phase 3: Editor UI & Crowdsourced Review (လူကိုယ်တိုင် စစ်ဆေးပြင်ဆင်ခြင်း)
* **Workspace Development:** Next.js နဲ့ TypeScript ကို သုံးပြီး Translator တွေ၊ Editor တွေ အလွယ်တကူ ဝင်ရောက်ပြင်ဆင်နိုင်မယ့် UI ကို တည်ဆောက်ပါ။ ဘယ်ဘက်မှာ မူရင်းစာ၊ ညာဘက်မှာ AI ဘာသာပြန်ထားတာကို ပြသပြီး Edit လုပ်ခွင့်ပေးထားပါ။
* **Version Control:** လူကိုယ်တိုင် ပြင်ဆင်ပြီးသွားရင် `human_edited` အနေနဲ့ Version အသစ်တစ်ခု ခွဲသိမ်းပါ။ မူလ AI ရေးထားတာကို ဖျက်မပစ်ပါနဲ့ (နောက်ပိုင်း Compare လုပ်ပြီး Loss function တွက်ဖို့ လိုလာနိုင်ပါတယ်)။
* **Popularity Metrics:** ဖတ်ရှုသူတွေဆီက Feedback ကောက်ပါ။ "လူကြိုက်များတဲ့ လူတည်းဖြတ်ထားတာ" ကို ခွဲခြားနိုင်ဖို့ Chapter တစ်ခုချင်းစီရဲ့ View count, User Rating, ဒါမှမဟုတ် Editor ရဲ့ ယုံကြည်ရမှု အဆင့် (Trust Score) တွေကို တွက်ချက်ပါ။
...
* **Cron Jobs:** တစ်ပတ်တစ်ခါ (သို့) တစ်လတစ်ခါ ဒီ Script ကို အလိုအလျောက် run ပြီး JSON data တွေ ထုတ်ပေးမယ့် စနစ် (Cron Job / Cloudflare Workers) လုပ်ထားပါ။
